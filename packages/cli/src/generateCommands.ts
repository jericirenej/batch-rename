...
const { programDescription, programOptions, programName, programVersion } = programConfiguration;
program.name(programName).version(programVersion).description(programDescription);
